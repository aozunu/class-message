...
<div class="lanrenzhijia">
			<div id="pg_title" class="pg_title">
				<?php
					...
					for($ii=0;$ii<count($mergearr);$ii++){
	                    if($ii == 0){
	                    	echo "<h1 style='display:block;top:25px;'>".$mergearr[$ii]['name']."的介绍</h1>";
	                    }else{
	                    	echo "<h1>".$mergearr[$ii]['name']."的介绍</h1>";
	                    }
	                }
				?>
			</div>
			<div id="pg_preview">
				<?php
					for($ii=0;$ii<count($mergearr);$ii++){
	                    if($ii == 0){
	                    	echo "<img class='pg_thumb' style='display:block;z-index:9999;' src='".$mergearr[$ii]['img']."' alt='".$mergearr[$ii]['img']."'/>";
	                    }
	                    echo "<img class='pg_thumb' src='".$mergearr[$ii]['img']."' alt='".$mergearr[$ii]['img']."'/>";
	                }
				?>
			</div>
	                    ...
	                    if($ii == 0){
	                    	echo "
								<div style='display:block;left:250px;'>
									<h2>".$mergearr[$ii]['name']."个人信息</h2>
									<p>
										电话：".$mergearr[$ii]['phone']."<br/>
										爱好：".$mergearr[$ii]['aihao']."<br/>
										学校：".$mergearr[$ii]['school']."<br/>
									</p>
								</div>
	                    	";
	                    }
				...
				<?php
					for($ii=0;$ii<count($mergearr);$ii++){
	                    if($ii == 0){
	              			echo "
								<div style='display:block;left:250px;'>
									<h2>".$mergearr[$ii]['name']."的地址</h2>
									<p>".$mergearr[$ii]['adris']."</p>
								</div>
	              			";
	                    }
              			echo "
					...
					<?php
						for($ii=0;$ii<count($mergearr);$ii++){
		                    if($ii == 0){
		              			echo "
									<div class='content'>
										<div><a href='#'><img src='".$mergearr[$ii]['img']."' alt='".$mergearr[$ii]['name']."' class='thumb' /></a></div>
									</div>
		              			";
		                    }
	              			echo "
        ...
        <div>
            <span class="reference">
				<!-- <a href="http://www.lanrenzhijia.com" target="_blank">懒人之家网站</a>
				<a href="http://www.lanrenzhijia.com" target="_blank">懒人之家网站</a> -->
			</span>
		</div>

        <!-- The JavaScript -->
        <script type="text/javascript" src="http://www.lanrenzhijia.com/ajaxjs/1.4.3/jquery-1.4.3.min.js"></script>
